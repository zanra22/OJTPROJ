...
if (isset($_POST['reg_user'])) {
  ...
  $firstname = mysqli_real_escape_string($db2, strtoupper($_POST['firstname']));
  $middlename = mysqli_real_escape_string($db2, strtoupper($_POST['middlename']));
  $lastname = mysqli_real_escape_string($db2, strtoupper($_POST['lastname']));
  ...
  $employee_Number =  mysqli_real_escape_string($db2, strtoupper($_POST['employee_N']));
  $dept = mysqli_real_escape_string($db2, strtoupper($_POST['department']));
  $position= mysqli_real_escape_string($db2, strtoupper($_POST['position']));
