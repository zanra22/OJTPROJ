...
<form class="content" action="pending_no_time_in.php" method="post">
	<table align="center">
		<tr>
			<!-- <th>I.D</th> -->
		...
		<?php 
			...
			$sql = "SELECT employeeNum,fullname,id, request_type, reason, is_approved FROM form WHERE is_approved='PENDING' AND request_type='NO IN'";
