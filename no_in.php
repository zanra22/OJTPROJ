...
<form action="no_in.php" method="post">
	...
	<table class="table table-bordered table-striped" align="center">
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
			    ...
			    echo '<td style="border: 1px solid #bb9121; color: #bb9121;"><input style="text-align:center;border: 1px solid #bb9121; color: #bb9121;background-color:black;" type = "text" readonly name = "request_type" value = "NO IN"></input></td>';
			    ...
			    echo '<td style="border: 1px solid #bb9121; color: #bb9121;"><button type= "Submit" name= "no_in_reg">Submit</button></td></tr>';
		    }
		}
	}
