...
function differenceInMinutes($endOfShift,$late_timein){
  $starttimestamp = strtotime($endOfShift);
  $endtimestamp = strtotime($late_timein);
  $difference = abs($starttimestamp - $endtimestamp)/3600;
  return $difference;
}
if(!empty($_POST["submit"])) {
  $hours_difference = differenceInMinutes($_POST["endOfShift"],$_POST["late_timein"]); 
...
<form id="formID" action="late_timein.php" method="post">
	...
	<table class="table table-bordered" align="center">
      ...
      <!-- <th>Request Type</th> -->
			...
			<th style="border: 1px solid #bb9121; color: #bb9121;">Late Time-In</th>
      ...
      <th style="border: 1px solid #bb9121; color: #bb9121;">Reason</th>
		...
		<?php 
			...
			if (isset($_SESSION['employee_N'])):
              ...
              ?>
              <input hidden style="text-align:center;" type = "text" readonly name = "request_type" value = "LATE TIME-IN"></input>
              ...
              <td style="border: 1px solid #bb9121; color: #bb9121;"><input style="text-align:center;border: 1px solid #bb9121; color: #bb9121;background-color:#fffacd;" required name="planDate" type="date" value="<?php if(!empty($_POST["planDate"])) { echo $_POST["planDate"]; } ?>"></input></td>
                ...
                <td style="border: 1px solid #bb9121; color: #bb9121;"><input style="text-align:center;border: 1px solid #bb9121; color: #bb9121;background-color:#fffacd;" required name="late_timein" value="<?php if(!empty($_POST["late_timein"])) { echo $_POST["late_timein"]; } ?>" type="time" placeholder="Start of Overtime"></td>
...
<button class="btn btn-outline-warning btn-lg" align="center" type="submit" name="latetimein_reg" value="Submit">Submit</button>
