...
<form id="formID" action="changeSchedule.php" method="post">
	...
	<table class="table table-bordered" align="center">
      ...
      <!-- <th>Request Type</th> -->
			...
			<th style="border: 1px solid #bb9121; color: #bb9121;">Desired Date</th>
			<th colspan="2" style="text-align: center; border: 1px solid #bb9121; color: #bb9121;">Regular Shit</th>
			<th colspan="2" style="border: 1px solid #bb9121; color: #bb9121;">Desired New Shift</th>
      ...
      <th style="border: 1px solid #bb9121; color: #bb9121;">Reason</th>
		...
		<?php 
			...
			if (isset($_SESSION['employee_N'])):
              ...
              ?>
              <input hidden style="text-align:center;" type = "text" readonly name = "request_type" value = "CHANGE SCHEDULE"></input>
...
<button class="btn btn-outline-warning btn-lg" align="center" type="submit" name="changeSchedule_reg" value="Submit">Submit</button>
