   ...
   <div class="formtable">
	<table class="table table-bordered table-striped" align="center">
		...
		if($_SESSION['type'] == 'HR'){
			...
			$sql = "SELECT employeeNum,fullname,id, request_type, reason, dept_approved FROM form WHERE dept_approved='APPROVED' AND request_type='LATE TIME-IN'";
...
if(isset($_POST['update']))
{
   ...
   $mail = new PHPMailer\PHPMailer\PHPMailer();                              // Passing `true` enables exceptions
    ...
    // $name = $_POST['name'];
    //Recipients
    $mail->setFrom('localhost', 'Late Time In Form Update');
...
if(isset($_POST['update']))
{
   ...
   $mail = new PHPMailer\PHPMailer\PHPMailer();                              // Passing `true` enables exceptions
    ...
    $mail->Body    = 'Your form has been reviewed, please check your account for more info.';
    // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
    ...
    $mail->send();
            ...
            echo '</td><input hidden name = email['.$row["id"].'] type = text readonly = readonly value ="'.$row["email"].'"></input>';
