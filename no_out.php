	...
	<table class="table table-bordered table-striped" align="center">
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
			    ...
			    echo '<td><input style="text-align:center;" type = "text" readonly name = "request_type" value = "NO OUT"></input></td>';

			    echo '<td><input style = "width:400px" type = "text" name = "reason_1"></input></td>';

			    echo '<td><button type= "Submit" name= "no_out_reg">Submit</button></td></tr>';
		    }
		}
	}
