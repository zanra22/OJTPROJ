...
function differenceInMinutes($startOfShift,$no_out){
  $starttimestamp = strtotime($startOfShift);
  $endtimestamp = strtotime($no_out);
  $difference = abs($starttimestamp - $endtimestamp)/3600;
  return $difference;
}
if(!empty($_POST["submit"])) {
  $hours_difference = differenceInMinutes($_POST["startOfShift"],$_POST["no_out"]); 
...
<form id="formID" action="no_out.php" method="post">
      ...
      <th style="border: 1px solid #bb9121; color: #bb9121;">Reason</th>
		...
		<?php 
			...
			if (isset($_SESSION['employee_N'])):
              ...
              ?>
              <input hidden style="text-align:center;" type = "text" readonly name = "request_type" value = "NO-OUT"></input>
              ...
              <td style="border: 1px solid #bb9121; color: #bb9121;"><input style="text-align:center;border: 1px solid #bb9121; color: #bb9121;background-color:#fffacd;" required name="planDate" type="date" value="<?php if(!empty($_POST["planDate"])) { echo $_POST["planDate"]; } ?>"></input></td>
                ...
                <td style="border: 1px solid #bb9121; color: #bb9121;"><input style="text-align:center;border: 1px solid #bb9121; color: #bb9121;background-color:#fffacd;" required name="no_out" value="<?php if(!empty($_POST["no_out"])) { echo $_POST["no_out"]; } ?>" type="time" placeholder="Start of Overtime"></td>
...
<button class="btn btn-outline-warning btn-lg" align="center" type="submit" name="no_out_reg" value="Submit">Submit</button>
